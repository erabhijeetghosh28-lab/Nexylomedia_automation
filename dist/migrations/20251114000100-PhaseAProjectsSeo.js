...
exports.PhaseAProjectsSeo20251114000100 = void 0;
const typeorm_1 = require("typeorm");
class PhaseAProjectsSeo20251114000100 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.createIndex("project_domains", new typeorm_1.TableIndex({
        ...
        await queryRunner.createIndex("site_pages", new typeorm_1.TableIndex({
        ...
        await queryRunner.createIndex("seo_audits", new typeorm_1.TableIndex({
        ...
        await queryRunner.createIndex("seo_issues", new typeorm_1.TableIndex({
    ...
    async down(queryRunner) {
        ...
        await queryRunner.dropIndex("seo_audits", "IDX_seo_audits_project_type_status");
        await queryRunner.dropTable("seo_audits");
        await queryRunner.dropIndex("site_pages", "IDX_site_pages_project_full_url");
        await queryRunner.dropTable("site_pages");
        await queryRunner.dropIndex("project_domains", "IDX_project_domains_project_host");
        await queryRunner.dropTable("project_domains");
        await queryRunner.dropIndex("projects", "IDX_projects_tenant_slug");
        await queryRunner.dropTable("projects");
    }
}
exports.PhaseAProjectsSeo20251114000100 = PhaseAProjectsSeo20251114000100;
//# sourceMappingURL=20251114000100-PhaseAProjectsSeo.js.map