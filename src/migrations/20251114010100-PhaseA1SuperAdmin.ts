...
export class PhaseA1SuperAdmin20251114010100 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.dropIndex(
      "tenant_usages",
      "IDX_tenant_usages_tenant_unique",
    );
    await queryRunner.dropTable("tenant_usages");

    await queryRunner.dropIndex(
      "tenant_quotas",
      "IDX_tenant_quotas_tenant_unique",
    );
    await queryRunner.dropTable("tenant_quotas");

    await queryRunner.dropIndex(
      "tenant_plans",
      "IDX_tenant_plans_code",
    );
